...
support should you ever need it.  The "project", on the other hadn, is
...
* Does the project have a documented and secure way to receive
  ...
  vulnerablity in such a way that that report does not become public
...
Regarding (1): Software fortunatelyq does not suffer very much from
...
project's project'designated user support forums are often a very good
...
concrete: electrical sockets.  You expectat that when you plug a lamp
